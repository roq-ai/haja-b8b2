...
function OrganizationListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<OrganizationInterface[]>(
    ...
    () =>
      getOrganizations({
        relations: ['user', 'blog_post.count', 'course.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('blog_post', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>blog_post</Th>}

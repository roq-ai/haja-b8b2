  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Haja - Your Ultimate Destination for Engaging Blogs and Comprehensive Online Courses. Dive into Knowledge, Anytime, Anywhere."
        />
      </Head>
      ...
      <Stack minH={'100vh'} direction={{ base: 'column', md: 'row' }}>
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Welcome to Haja - Your Ultimate Destination for Engaging Blogs and Comprehensive Online Courses. Dive into Knowledge, Anytime, Anywhere.`}
            </Text>
        ...
        <Flex position="relative" flex={1}>
          <Image
            src={
              'https://images.unsplash.com/photo-1501504905252-473c47e087f8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxibG9nJTJDb25saW5lJTIwY291cnNlc3xlbnwwfHx8fDE2ODc5NTE5MTB8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt={'Login Image'}
            objectFit={'cover'}
          />
